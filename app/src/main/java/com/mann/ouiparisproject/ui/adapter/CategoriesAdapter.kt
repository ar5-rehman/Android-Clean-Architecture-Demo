...
import com.mann.ouiparisproject.data.model.Category
import com.mann.ouiparisproject.data.model.CategoryModel

class CategoriesAdapter (private var context: Context, private var list: List<CategoryModel>): RecyclerView.Adapter<CategoriesAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val categoryItem: CategoryModel = list[position]
