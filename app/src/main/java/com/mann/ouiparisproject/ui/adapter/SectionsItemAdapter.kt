...
import com.mann.ouiparisproject.data.model.Item
import com.mann.ouiparisproject.data.model.SectionModel

class SectionsItemAdapter(val item: SectionModel, val list: List<Item>, val context: Context) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val discoveryPojo: Item = list[position]
